...
// WorldGuard
CSRS_GEN_ACCESSORS_NAMED(hslwid, CSR_HSLWID)
CSRS_GEN_ACCESSORS_NAMED(hwiddeleg, CSR_HWIDDELEG)
CSRS_GEN_ACCESSORS_NAMED(hwiddelegh, CSR_HWIDDELEGH)
CSRS_GEN_ACCESSORS_NAMED(hwiddelegh2, CSR_HWIDDELEGH2)
CSRS_GEN_ACCESSORS_NAMED(hwiddelegh3, CSR_HWIDDELEGH3)
